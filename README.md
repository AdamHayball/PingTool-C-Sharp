# Network Ops Ping Tool
![Dual IP Ping Tab](https://github.com/AdamHayball/PingTool-C-Sharp/blob/main/Images/PingTool-PingTab.jpg)

## Features:
- Simultaneous Dual IP / Hostname Ping With
  - Live Graph
  - Default Flood Ping
  - Ping Count Setting
  - Packet Sizing
- MAC Address Origin Lookup
  - Detailed Device Origin Information
- Cellular Hotspot Signal Analysis
- DSL Modem Signal Analysis
- Cable Modem Signal Analysis
